# Generated by Django 3.2.16 on 2023-01-08 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_submissions', models.IntegerField(blank=True, default=None, help_text='Maximum number of submissions for this problem, or leave blank for no limit.', null=True, validators=[judge.models.contest.MinValueOrNoneValidator(1, "Why include a problem you can't submit to?")], verbose_name='max submissions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_required', models.BooleanField(default=False, help_text='Whether members are compelled to select a class when joining.', verbose_name='class membership required')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memory_limit', models.PositiveIntegerField(help_text='The memory limit for this problem, in kilobytes (e.g. 256mb = 262144 kilobytes).', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1048576)], verbose_name='memory limit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checker', models.CharField(blank=True, choices=[('bridged', 'Custom'), ('standard', 'Standard'), ('floats', 'Floats'), ('floatsabs', 'Floats (absolute)'), ('floatsrel', 'Floats (relative)'), ('rstripped', 'Non-trailing spaces'), ('sorted', 'Unordered'), ('identical', 'Byte identical'), ('linecount', 'Line-by-line')], max_length=10, verbose_name='checker')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interactor', models.FileField(blank=True, null=True, storage=judge.utils.problem_data.ProblemDataStorage(), upload_to=judge.models.problem_data.problem_directory_file, verbose_name='interactor file')),
                ('output_prefix', models.IntegerField(blank=True, null=True, verbose_name='output prefix length')),
                ('output_limit', models.IntegerField(blank=True, null=True, verbose_name='output limit length')),
                ('feedback', models.TextField(blank=True, verbose_name='init.yml generation feedback')),
                ('checker', models.CharField(blank=True, choices=[('bridged', 'Custom'), ('standard', 'Standard'), ('floats', 'Floats'), ('floatsabs', 'Floats (absolute)'), ('floatsrel', 'Floats (relative)'), ('rstripped', 'Non-trailing spaces'), ('sorted', 'Unordered'), ('identical', 'Byte identical'), ('linecount', 'Line-by-line')], max_length=10, verbose_name='checker')),
                ('checker_file', models.FileField(blank=True, null=True, storage=judge.utils.problem_data.ProblemDataStorage(), upload_to=judge.models.problem_data.problem_directory_file, verbose_name='checker file')),
                ('checker_args', models.TextField(blank=True, help_text='Checker arguments as a JSON object.', verbose_name='checker arguments')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='judge.class', verbose_name='class')),
        ...
        migrations.AddField(
            model_name='class',
            name='members',
            field=models.ManyToManyField(blank=True, related_name='classes', related_query_name='class', to='judge.Profile', verbose_name='members'),
        ),
        migrations.AddField(
            model_name='class',
            name='organization',
